...
# 📝 Publications 
1. <span style="background-color:#007BFF; color:white; padding:2px 4px; border-radius:3px;">信息提示</span>**Diju Liu**, Wang, Yalin and Liu, Chenliang and Yuan, Xiaofeng and Yang, Chunhua and Gui, Weihua, [Data Mode Related Interpretable Transformer Network for Predictive Modeling and Key Sample Analysis in Industrial Processes.](https://ieeexplore.ieee.org/abstract/document/9976255), **IEEE Transactions on Industrial Informatics**, 2022, 19(9): 9325-9336. **([Download PDF](./papers/TII2023.pdf))**
